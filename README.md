# 🎵 Diez Producciones - Landing Page

Landing page oficial de **Diez Producciones**

Presentación moderna de eventos, banda y servicios audiovisuales.
...
| Aspecto    | Descripción                    |
| ---------- | ------------------------------ |
| Objetivo   | Sitio web de presentación      |
| Tipo       | Landing Page                   |
...
- **Banda** - Info sobre la banda y miembros
- **Galería** - Portfolio de eventos y fotos
- **Info Evento** - Detalles del próximo evento
- **Sobre Nosotros** - Historia y valores
- **Banner Preventa** - Promoción de venta anticipada
- **Footer** - Links sociales (Spotify, YouTube)
